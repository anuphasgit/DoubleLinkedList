 ...
 * get you started.
 * 
 * @author mvail, mhthomas, awinters, abhattarai
 */
...
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(emptyList_addToRearA_A, "emptyList_addToRear_A",LIST_A,STRING_A);
		testSingleElementList(emptyList_iterAddA_A,"emptyList_iterAddA_A" , LIST_A, STRING_A);
		//1-element to empty list
		testEmptyList(A_removeFirst_emptyList_,"A_removeFirst_emptyList_");
		...
		testSingleElementList(Aset_0B_B,"A_set_0B_B",LIST_B,STRING_B);
		...
		testTwoElementList(BAset_0C_CA, "BAset_0C_CA",LIST_CA,STRING_CA);
		...
		//3-element to changed 3 element list
		testThreeElementList(ABC_set_0D_DBC, "ABC_set_0D_DBC", LIST_DBC, STRING_DBC);
	...
	/**Scenario emptyList -> addToRear(A)->[A]
	 * 
	...
	/**Scenario emptyList ->iterAdd(A) -> [A]
	 * 
	 * @return [A] after iterAdd(A)
	 */
	private IndexedUnsortedList<Integer> emptyList_iterAddA_A(){
		IndexedUnsortedList<Integer> list = newList();
		ListIterator<Integer> iteratorr = list.listIterator();
		iteratorr.add(ELEMENT_A);
		return list;
	}
	 ...
	 */
	private IndexedUnsortedList<Integer> A_removeFirst_emptylist_(){
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.remove(ELEMENT_A);
		return list;
	}
	private Scenario<Integer> A_removeFirst_emptyList_ = () -> A_removeFirst_emptylist_();
	...
	private IndexedUnsortedList<Integer> A_iterNextRemove_emptyList(){
		IndexedUnsortedList<Integer> list = emptyList_addA_A();
		Iterator<Integer> iteratorr = list.iterator();
		iteratorr.next();
		iteratorr.remove();
		return list;
	}
	 ...
	 */
	private IndexedUnsortedList<Integer> Aset_0B_B(){
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.set(0, ELEMENT_B);
		return list;
		}
	private Scenario<Integer> Aset_0B_B = () -> Aset_0B_B();
	 ...
	 */
	IndexedUnsortedList<Integer> AB_remove0_B(){
	 ...
	 */
	IndexedUnsortedList<Integer> AB_remove1_A(){
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		list.remove(1);
		return list;
	}
	...
	private IndexedUnsortedList<Integer> AB_removeB_A(){
		IndexedUnsortedList<Integer> list = A_addAfterA_AB();
	 ...
	 */
	private IndexedUnsortedList<Integer> BAset_0C_CA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.addToFront(ELEMENT_B); 
		list.set(0, ELEMENT_C);
		return list;
	}
	private Scenario<Integer> BAset_0C_CA = () -> BAset_0C_CA();
	 ...
	 * 
	 * @return [A,B,C] afteer addToRear(C)
	 */
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_set_0D_DBC(){
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		list.set(0, ELEMENT_D);
		return list;
	}
	private Scenario<Integer> ABC_set_0D_DBC = ()-> ABC_set_0D_DBC();
	...
	private void testSingleElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIterNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext
					(scenario.build().listIterator(), 1), 1), Result.NoException));
				printTest(scenarioName + "_testListIterNextPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext
					(scenario.build().listIterator(), 1), 1)), Result.IllegalState));
				printTest(scenarioName + "_testListIterNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext
					(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext
					(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));
				...
				printTest(scenarioName + "_testListIter0NextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext
					(scenario.build().listIterator(0), 1), 1), Result.NoException));
				printTest(scenarioName + "_testListIter0NextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext
					(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIter0NextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext
					(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));
